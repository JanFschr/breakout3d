...
const blocks: BlockDefinition[] = [
  ...brickGrid({
    prefix: 'front', face: 'front', rows: 8, x: nineX, startY: 12.0, rowStep: 0.92, width: 1.16, height: 0.64,
    cell: (row, column) => {
  ...
  { id: 'anchor-front-left', type: 'anchor', face: 'front', edge: 'left', x: -5.8, y: 20.6, width: 1.05, height: 0.95, hitPoints: 2, score: 220 },
  { id: 'anchor-front-top', type: 'anchor', face: 'front', edge: 'top', x: 0, y: 20.6, width: 1.05, height: 0.95, hitPoints: 2, score: 220 },
  { id: 'anchor-front-right', type: 'anchor', face: 'front', edge: 'right', x: 5.8, y: 20.6, width: 1.05, height: 0.95, hitPoints: 2, score: 220 },

  ...brickGrid({
    prefix: 'right', face: 'right', rows: 7, x: eightX, startY: 12.2, rowStep: 1, width: 1.25, height: 0.66,
    cell: (row, column) => {
  ...
  { id: 'generator-g1', type: 'generator', face: 'right', x: 0, y: 19.7, width: 2.05, height: 1.05, hitPoints: 4, score: 600 },
  { id: 'anchor-right-top', type: 'anchor', face: 'right', edge: 'top', x: -4.9, y: 20.8, width: 1, height: 0.9, hitPoints: 2, score: 220 },
  { id: 'anchor-right-back', type: 'anchor', face: 'right', edge: 'right', x: 4.9, y: 20.8, width: 1, height: 0.9, hitPoints: 3, score: 260 },

  ...brickGrid({
    prefix: 'top', face: 'top', rows: 6, x: sevenX, startY: 12.5, rowStep: 1.05, width: 1.38, height: 0.68,
    cell: (row, column) => row === 3 && column >= 1 && column <= 5 ? { type: 'chain', score: 180 } : {},
  }),
  { id: 'anchor-top-back', type: 'anchor', face: 'top', edge: 'top', x: 0, y: 20.25, width: 1.05, height: 0.95, hitPoints: 2, score: 240 },

  ...brickGrid({
    prefix: 'left', face: 'left', rows: 6, x: sevenX, startY: 12.5, rowStep: 1.05, width: 1.38, height: 0.68,
    cell: (row, column) => row === 2 && (column === 0 || column === 6) ? { type: 'chain', score: 180 } : {},
  }),
  { id: 'generator-g2', type: 'generator', face: 'left', x: 0, y: 19.7, width: 2.05, height: 1.05, hitPoints: 4, score: 600 },
  { id: 'anchor-left-back', type: 'anchor', face: 'left', edge: 'left', x: -5.1, y: 20.75, width: 1, height: 0.9, hitPoints: 2, score: 240 },

  ...brickGrid({
    prefix: 'back', face: 'back', rows: 6, x: eightX, startY: 12.55, rowStep: 1.05, width: 1.25, height: 0.66,
    cell: (row) => row === 5 ? { type: 'armor', group: 'back-armor', hitPoints: 7, score: 220 } : {},
  }),
  { id: 'core-back', type: 'core', face: 'back', x: 0, y: 19.95, width: 2.45, height: 1.25, hitPoints: 5, exposed: false, score: 2200 },
];
...
export const REACTOR_GARDEN_LEVEL = {
  ...
  mastery: { comboTimeoutSeconds: 3.6, fullOrbitFaces: 4, overdriveSeconds: 8 },
  scoring: { parSeconds: 350, comboPeakTarget: 44, orbitTierTarget: 3, scoreTarget: 24500, starThresholds: [60, 84] },
